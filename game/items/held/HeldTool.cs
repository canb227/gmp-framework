...
/// <summary>
/// Root script of a <see cref="ToolItem"/>'s in-hand scene. The player instantiates it under the camera's item
...
/// </summary>
public partial class HeldTool : Node3D
{
    ...
    public virtual void Equip(FactoryItem item, FactoryPlayer player)
    {
        this.item = item;
        this.player = player;
    }
