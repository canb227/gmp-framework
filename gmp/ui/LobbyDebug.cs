...
public partial class LobbyDebug : Control
{
    ...
    private const string DemoCubeName = "ConveyorDemoOre"; // a 1 m cube tips over the salvage slopes' guards
